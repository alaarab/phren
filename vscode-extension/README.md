...
- `cortex.mcpServerPath` configured to the MCP server entrypoint file (for example: `/home/alaarab/.nvm/versions/node/v24.13.0/lib/node_modules/@alaarab/cortex/mcp/dist/index.js`).
