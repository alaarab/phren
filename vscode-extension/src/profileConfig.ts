...
export interface ProfileConfigSummary {
  name: string;
  file: string;
  description?: string;
  projects: string[];
...
export function readMachineName(): string {
  try {
...
export function writeMachineName(machine: string): void {
...
export function machinesConfigPath(storePath: string): string {
  return path.join(storePath, "machines.yaml");
}

export function listProfileConfigs(storePath: string): ProfileConfigSummary[] {
...
export function readMachinesMap(storePath: string): Record<string, string> {
...
export function setMachineProfile(storePath: string, machine: string, profile: string): string {
...
export function readDeviceContext(storePath: string): DeviceContext {
...
function firstScalar(raw: string, key: string): string | undefined {
