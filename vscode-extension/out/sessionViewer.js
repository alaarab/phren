...
exports.showSessionOverview = showSessionOverview;
const previewPanel_1 = require("./previewPanel");
async function showSessionOverview(client, session) {
    try {
...
function renderSessionHtml(session, findings, tasks) {
...
function renderErrorHtml(session, error) {
