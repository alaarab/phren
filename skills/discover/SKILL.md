...
- web-project-1/LEARNINGS.md: last updated 45 days ago
...
- web-project-1 LEARNINGS.md mentions "always run parity check" 4 times. Already have `/parity`, but it's not in the workflow skill.

## Section 4: Backlog Health

- web-project-1: 12 items (3 completed, 2 stale > 60 days)
...
- web-project-1#7: "Column virtualization perf" (added 75 days ago, no progress)
