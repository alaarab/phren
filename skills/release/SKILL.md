---
name: release
description: Ship a version to npm or PyPI. Version bump, changelog, tag, publish.
---
...
Check if the project has its own `/publish` skill. If it does, defer to that for project-specific steps (e.g., livemcp needs to test with Ableton, WebProject1 has a GitHub Actions workflow). The steps below are the universal baseline.
