...
Open-source framework that gives Claude persistent memory across sessions and machines. Published as `@alaarab/phren` on npm.
...
| `mcp/src/cli.ts` | CLI subcommands: search, shell, hooks, doctor, web-ui, governance commands |
| `mcp/src/utils.ts` | Utilities: FTS5 sanitization, synonym expansion, keyword extraction |
| `mcp/src/init.ts` | `npx @alaarab/phren init`: configures MCP + hooks for all detected agents |
| `mcp/src/link.ts` | `npx @alaarab/phren link`: sync profile, symlinks, hooks, context |
...
| `skills/` | Phren slash commands: sync, init, discover, consolidate |
...
**Search and browse:**
- `search_knowledge(query, type?, limit?, project?)` : FTS5 search with synonym expansion (renamed from search_phren)
...
- `complete_tasks(project, items[])` : bulk complete multiple tasks in one call
- `update_task(project, item, updates)` : update priority, context, or section
...
**Session management:**
- `session_start(project?)` : mark session start, returns prior summary + recent findings + active tasks
...
phren maintain migrate <project>      Promote legacy findings
...
- /phren-consolidate skill: archives old entries in details block, writes marker, promotes cross-project patterns to global at 3+ projects
...
User Prompt -> SessionStart (git pull) -> UserPromptSubmit (FTS5 search, inject context)
     |                                            |
     v                                            v
 MCP Tools (add_finding, tasks, etc.)      Governance (trust filter, confidence decay)
     |                                            |
     v                                            v
...
- Task Done sections are stripped from FTS index to reduce noise
...
| Command | Skill | Scope | Source |
| --- | --- | --- | --- |
| `/backlog` | `backlog` | `global` | `/home/alaarab/.phren/global/skills/backlog.md` |
| `/codex` | `codex` | `global` | `/home/alaarab/.phren/global/skills/codex.md` |
| `/codex-iterate` | `codex-iterate` | `global` | `/home/alaarab/.phren/global/skills/codex-iterate.md` |
| `/codex-swarm` | `codex-swarm` | `global` | `/home/alaarab/.phren/global/skills/codex-swarm.md` |
| `/phren` | `phren` | `global` | `/home/alaarab/.phren/global/skills/phren.md` |
| `/phren-consolidate` | `phren-consolidate` | `global` | `/home/alaarab/.phren/global/skills/phren-consolidate.md` |
| `/phren-discover` | `phren-discover` | `global` | `/home/alaarab/.phren/global/skills/phren-discover.md` |
| `/phren-init` | `phren-init` | `global` | `/home/alaarab/.phren/global/skills/phren-init.md` |
| `/phren-learn` | `phren-learn` | `global` | `/home/alaarab/.phren/global/skills/phren-learn.md` |
| `/phren-sync` | `phren-sync` | `global` | `/home/alaarab/.phren/global/skills/phren-sync.md` |
| `/phren-update` | `phren-update` | `global` | `/home/alaarab/.phren/global/skills/phren-update.md` |
| `/creative` | `creative` | `global` | `/home/alaarab/.phren/global/skills/creative.md` |
| `/humanize` | `humanize` | `global` | `/home/alaarab/.phren/global/skills/humanize.md` |
| `/pipeline` | `pipeline` | `global` | `/home/alaarab/.phren/global/skills/pipeline.md` |
| `/release` | `release` | `global` | `/home/alaarab/.phren/global/skills/release.md` |
| `/swarm` | `swarm` | `global` | `/home/alaarab/.phren/global/skills/swarm.md` |
| `/swarm-codex` | `swarm-codex` | `global` | `/home/alaarab/.phren/global/skills/swarm-codex.md` |
