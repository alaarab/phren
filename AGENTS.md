...
**Data management:**
- `add_project(path, profile?)` : bootstrap a directory into phren and add to active profile
...
| `/phren-task-audit` | `phren-task-audit` | `global` | `/home/alaarab/.phren/global/skills/phren-task-audit.md` |
...
| `/parity` | `parity` | `phren` | `/home/alaarab/.phren/phren/skills/parity.md` |
...
| `/tmux-swarm` | `tmux-swarm` | `global` | `/home/alaarab/.phren/global/skills/tmux-swarm.md` |
| `/video` | `video` | `global` | `/home/alaarab/.phren/global/skills/video.md` |
