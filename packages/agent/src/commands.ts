...
const { DIM, BOLD, CYAN, GREEN, RED, YELLOW, RESET } = ANSI;
...
// ── Command handler type and registry ─────────────────────────────────────

type CommandHandler = (parts: string[], ctx: CommandContext) => boolean;

function handleHelp(_parts: string[], _ctx: CommandContext): boolean {
...
function handleModel(parts: string[], ctx: CommandContext): boolean {
...
function handleProvider(_parts: string[], _ctx: CommandContext): boolean {
  process.stderr.write(formatProviderList());
  return true;
}

function handleTurns(_parts: string[], ctx: CommandContext): boolean {
...
function handleClear(_parts: string[], ctx: CommandContext): boolean {
...
function handleCost(_parts: string[], ctx: CommandContext): boolean {
...
function handlePlan(_parts: string[], ctx: CommandContext): boolean {
  const tools: string[] = [];
...
function handleUndo(_parts: string[], ctx: CommandContext): boolean {
...
function handleHistory(parts: string[], ctx: CommandContext): boolean {
...
function handleCompact(parts: string[], ctx: CommandContext): boolean {
...
function handleContext(_parts: string[], ctx: CommandContext): boolean {
  const msgs = ctx.session.messages;
...
function handleBtw(parts: string[], ctx: CommandContext): boolean {
...
function handleSpawn(parts: string[], ctx: CommandContext): boolean {
  if (!ctx.spawner) {
...
function handleAgents(_parts: string[], ctx: CommandContext): boolean {
  if (!ctx.spawner) {
...
function handlePreset(parts: string[], _ctx: CommandContext): boolean {
  const sub = parts[1]?.toLowerCase();
...
function handleEffort(parts: string[], _ctx: CommandContext): boolean {
...
function handleExit(_parts: string[], _ctx: CommandContext): boolean {
  process.exit(0);
}
