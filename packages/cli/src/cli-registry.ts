...
export const REGISTRY: Command[] = [
  ...
  },
  {
    ...
    summary: "Index a project's code and look up its functions, types and where they are used",
    subcommands: [
      { name: "index", usage: "phren code index <project> [--full] [--repo <path>]", summary: "Build or refresh the code index" },
      { name: "status", usage: "phren code status <project> [--top <n>]", summary: "Show index counts, languages and the most used functions and types" },
      { name: "search", usage: "phren code search <project> <query> [--kind k] [--limit n]", summary: "Find functions, types and variables by name" },
      { name: "outline", usage: "phren code outline <project> <path>", summary: "A file's functions, types and variables in source order, nested" },
      { name: "refs", usage: "phren code refs <project> <name>", summary: "Where a function, type or variable is used, grouped by file" },
      { name: "def", usage: "phren code def <project> <name>", summary: "Where it is defined: doc, snippet and last change" },
      { name: "usage", usage: "phren code usage <project> [--top n]", summary: "Most and least used functions and types" },
    ],
