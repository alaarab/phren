...
export function shellHelpText(): string {
  ...
  return [
    ...
    `  ${style.bold("Graph")}        ${k("↑↓←→")} ${d("walk")}  ${k("1-9")} ${d("neighbour")}  ${k("↵")} ${d("select / focus")}  ${k("w")} ${d("watch")}`,
    ...
    "",
    "",
    hdr("Editor  (E, or e for $EDITOR)"),
    `  ${k("h j k l")} ${d("move")}  ${k("w b")} ${d("word")}  ${k("0 $")} ${d("line")}  ${k("gg G")} ${d("file")}`,
    `  ${k("i a I A")} ${d("insert")}  ${k("o O")} ${d("open line")}  ${k("x")} ${d("delete char")}  ${k("dd")} ${d("delete line")}`,
    `  ${k("yy")} ${d("yank")}  ${k("p P")} ${d("paste")}  ${k("u")} ${d("undo")}  ${k("/")} ${d("search")}  ${k("n N")} ${d("next / prev")}`,
    `  ${k(":w")} ${d("write")}  ${k(":q")} ${d("quit")}  ${k(":wq")} ${d("write and quit")}  ${k(":q!")} ${d("discard")}`,
    "",
