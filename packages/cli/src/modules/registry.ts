...
export const BUILTIN_MODULES: readonly ModuleManifest[] = [
  ...
  },
  {
    ...
    hookRoutes: [
      ...
      ...routes("POST", [
        ...
        "/v1/workspaces/close", "/v1/prompt", "/v1/model", "/v1/side-question/dismiss", "/v1/keys", "/v1/secret", "/v1/upload",
        "/v1/approvals/answer", "/v1/questions/answer", "/v1/subagents/resume", "/v1/subagents/archive-finished", "/v1/canary",
        "/v1/speech",
      ]),
      ...routes("WS", ["/v1/transcripts", "/v1/status", "/v1/overview"]),
    ],
    capabilities: [
      ...
      "files", "repositoryFiles", "subagents", "sideQuestions", "approvalPush", "simulators", "overviewStream", "speech",
    ],
  ...
  },
  {
    ...
    agentHooks: [],
    hookRoutes: [...routes("GET", ["/v1/code/tree", "/v1/code/usage-page", "/v1/code/recent", "/v1/code/status", "/v1/code/search", "/v1/code/outline", "/v1/code/outline-summary", "/v1/code/file-references", "/v1/code/definition", "/v1/code/references", "/v1/code/usage"]), ...routes("POST", ["/v1/code/note", "/v1/code/reindex", "/v1/code/disable"])],
    capabilities: ["code"],
