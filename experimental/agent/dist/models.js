...
export function getDefaultReasoningEffort(provider, model) {
    return getModelMetadata(provider, model)?.reasoningDefault ?? undefined;
}
export function getReasoningRange(provider, model) {
    return [...(getModelMetadata(provider, model)?.reasoningRange ?? [])];
}
export function lookupMaxOutputTokens(model, provider) {
