...
Current public surface: 68 MCP tools across 16 modules, exposed through two profiles: `core` (10 tools, the default) and `full`; see `api-reference.md`.
