...
- Generated runtime metadata such as `cortex.SKILL.md` is derived from the live tool registry during link/setup so tool counts and descriptions stay aligned with the code.
