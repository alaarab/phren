...
```sh
npx --yes @phren/cli@0.2.15 bridge install
npx --yes @phren/cli@0.2.15 bridge doctor
```
...
```sh
npx --yes @phren/cli@0.2.15 bridge status
npx --yes @phren/cli@0.2.15 bridge update
npx --yes @phren/cli@0.2.15 bridge rollback
npx --yes @phren/cli@0.2.15 bridge uninstall
```
