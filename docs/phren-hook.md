...
```sh
npx --yes @phren/cli@0.3.2 bridge install
npx --yes @phren/cli@0.3.2 bridge doctor
```
...
```sh
npx --yes @phren/cli@0.3.2 bridge status
npx --yes @phren/cli@0.3.2 bridge update
npx --yes @phren/cli@0.3.2 bridge rollback
npx --yes @phren/cli@0.3.2 bridge uninstall
```
