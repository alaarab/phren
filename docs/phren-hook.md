...
npx --yes @phren/cli@0.3.4 bridge doctor
```
...
```sh
npx --yes @phren/cli@0.3.4 bridge status
npx --yes @phren/cli@0.3.4 bridge update
npx --yes @phren/cli@0.3.4 bridge rollback
npx --yes @phren/cli@0.3.4 bridge uninstall
```
