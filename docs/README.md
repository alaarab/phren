...
- `docs/llms-install.md`: Installation guide, all 72 MCP tools, hooks, and memory governance pipeline.
...
- `docs/internal/shell-spec.md`: Product/UX contract for the interactive `phren` shell.
