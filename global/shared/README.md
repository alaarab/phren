...
```markdown
@import shared/web-project-1-conventions.md
```
...
- Library conventions used by multiple consumer projects (like `web-project-1-conventions.md`)
...
| File | What it covers |
|------|---------------|
| `web-project-1-conventions.md` | WebProject1 package naming, key types (IColumnDef, IDataSource, IFetchParams), consumer project relationships |
