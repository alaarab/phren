...
extension PhrenConnection {
    public static func gitStage(host: LiveHost, privateKey: Data, target: AgentChatTarget, child: String? = nil, paths: [String]) async throws {
        try await gitWrite(host: host, privateKey: privateKey, target: target, route: "stage", child: child, paths: paths)
    }

    public static func gitUnstage(host: LiveHost, privateKey: Data, target: AgentChatTarget, child: String? = nil, paths: [String]) async throws {
        try await gitWrite(host: host, privateKey: privateKey, target: target, route: "unstage", child: child, paths: paths)
    }

    public static func gitDiscard(host: LiveHost, privateKey: Data, target: AgentChatTarget, child: String? = nil, paths: [String]) async throws {
        try await gitWrite(host: host, privateKey: privateKey, target: target, route: "discard", child: child, paths: paths)
    }

    private static func gitWrite(host: LiveHost, privateKey: Data, target: AgentChatTarget, route: String,
                                 child: String?, paths: [String]) async throws {
        ...
        let request = try gitWriteRequest(target: target, route: route, child: child, paths: paths)
    ...
    static func gitWriteRequest(target: AgentChatTarget, route: String, child: String?, paths: [String]) throws -> GatewayRequest {
