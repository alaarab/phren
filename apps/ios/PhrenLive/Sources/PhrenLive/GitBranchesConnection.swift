...
extension PhrenConnection {
    ...
    public static func gitBranches(host: LiveHost, privateKey: Data, target: AgentChatTarget, child: String? = nil) async throws -> GitBranches {
        ...
        let request = try gitBranchesRequest(target: target, child: child)
    ...
    static func gitBranchesRequest(target: AgentChatTarget, child: String?) throws -> GatewayRequest {
