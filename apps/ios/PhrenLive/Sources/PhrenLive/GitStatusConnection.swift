...
extension PhrenConnection {
    ...
    public static func gitStatus(host: LiveHost, privateKey: Data, target: AgentChatTarget, child: String? = nil) async throws -> GitStatus {
        ...
        let request = try gitStatusRequest(target: target, child: child)
    ...
    static func gitStatusRequest(target: AgentChatTarget, child: String?) throws -> GatewayRequest {
